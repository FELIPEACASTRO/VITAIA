...
export class AdvancedSecurityService {
  ...
  static anonymizeMedicalData(data: any): any {
    ...
    if (anonymized.examResults) {
      anonymized.examResults = this.addDifferentialPrivacyNoise(
        anonymized.examResults
      );
    }
  ...
  private static addDifferentialPrivacyNoise(
    data: any,
    epsilon: number = 1.0
  ): any {
...
export const rolePermissions: Record<UserRole, Permission[]> = {
  ...
  [UserRole.RESEARCHER]: [Permission.READ_PATIENT_DATA, Permission.EXPORT_DATA],
