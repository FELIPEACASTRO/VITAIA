...
export default function ReportGenerator() {
  ...
  const generateReportMutation =
    trpc.reports.generateConsultationReport.useQuery(
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-1 text-sm">
                  ...
                  <p>
                    ...
                    {reportData.patient?.dateOfBirth || "N/A"}
                  </p>
                  <p>
                    <strong>Gênero:</strong>{" "}
                    {reportData.patient?.gender || "N/A"}
                  </p>
                  <p>
                    <strong>Email:</strong> {reportData.patient?.email || "N/A"}
                  </p>
                  <p>
                    <strong>Telefone:</strong>{" "}
                    {reportData.patient?.phone || "N/A"}
                  </p>
                </div>
              </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-700">
                      {reportData.consultation?.symptoms || "N/A"}
                    </p>
                  </div>
                      ...
                      >
                        ...
                        {exam.interpretation && (
                          <p className="text-gray-600 mt-1">
                            <em>Interpretação: {exam.interpretation}</em>
                          </p>
                        )}
                      </div>
                    ))}
              ...
              {reportData.aiSuggestions &&
                reportData.aiSuggestions.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-2">
                      {reportData.aiSuggestions.map(suggestion => (
                        <div
                          key={suggestion.id}
                          className="bg-blue-50 p-4 rounded-lg text-sm border border-blue-200"
                        >
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            Confiança: {suggestion.confidence}% | Status:{" "}
